    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center p-6 pb-12 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="flex flex-col items-center mt-8 mb-8">
          ...
          <p className="text-slate-400 dark:text-slate-400 text-[11px] xs:text-xs sm:text-sm font-medium mt-1 whitespace-nowrap">Your Smart AI Club & Study Companion</p>
        </div>
